...
const ChatContainer = ({selectedUser, setSelectedUser}) => {
  ...
  return selectedUser ? (
   ...
   <div className='flex items-center gap-3 py-3 mx-4 border-stone-500'>
    ...
    <p className='flex-1 text-white flex flex items-center gap-2'>
    Martin Johnson
...
<div className='flex-1 flex items-center bg-gray-100/11 rounded-full p-2'>
  <input type="text" placeholder='Send a message....' className='flex-1 text-sm border-none outline-none text-white placeholder-gray-400 '/>
